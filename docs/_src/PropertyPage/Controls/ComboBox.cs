...
public class ComboBoxDataModel
{
    ...
    [ComboBoxItemsSource(typeof(CustomStringItemsProvider))]
    [ControlTag(nameof(Options3))]
    public string Options3 { get; set; } = "B";

    [ComboBoxItemsSource(typeof(CustomIntItemsProvider))]
    ...
    [ComboBoxItemsSource(typeof(CustomDependencyProvider), nameof(Options3), nameof(Options4))]
