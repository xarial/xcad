...
namespace Xarial.XCad.Documentation
{
    ...
    {
        public override CustomFeatureRebuildResult OnRebuild(ISwApplication app, ISwDocument model, SwMacroFeature feature, MacroFeaturePrimitiveParams parameters, out AlignDimensionDelegate<MacroFeaturePrimitiveParams> alignDim)
        {
            alignDim = null;
