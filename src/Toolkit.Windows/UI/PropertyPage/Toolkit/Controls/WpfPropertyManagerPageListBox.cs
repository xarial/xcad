...
{
    internal class WpfPropertyManagerPageListBox : WpfPropertyManagerPageItemsSourceControl<object>
    {
        public override DataTemplate Template { get; }

        protected override event ControlValueChangedDelegate<object> ValueChanged;

        public WpfPropertyManagerPageListBox(IXApplication app, IGroup parentGroup, IIconsCreator iconConv,
            IAttributeSet atts, IMetadata[] metadata)
            : base(app, parentGroup, atts, metadata, iconConv)
        {
            Template = ControlTemplates.ListBox;
        }
