...
{
    internal class WpfPropertyManagerPageOptionBox : WpfPropertyManagerPageItemsSourceControl<object>
    {
        public override DataTemplate Template { get; }

        protected override event ControlValueChangedDelegate<object> ValueChanged;

        public WpfPropertyManagerPageOptionBox(IXApplication app, IGroup parentGroup, IIconsCreator iconConv,
            IAttributeSet atts, IMetadata[] metadata)
            : base(app, parentGroup, atts, metadata, iconConv)
        {
            Template = ControlTemplates.OptionBox;
        }
